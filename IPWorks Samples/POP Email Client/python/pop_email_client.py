      ...
      if str(command).startswith("?"):
        ...
        if mailcount != 0:
          ...
          for i in range(0,int(mailcount)):
            ...
            pop.retrieve()
            print((str(i+1) + ") ").ljust(5) + pop.get_message_from().ljust(50)[:50] + " " + pop.get_message_subject().ljust(50)[:50] + " " + str(pop.get_message_size()))
        else:
        ...
        htmlmailer.set_subject("Re: " + pop.getMessageSubject())
