...
if len(sys.argv) < 4:
  print("usage: htmlmailer.py [options] server from to")
  print("Options: ")
  ...
  print("\r\nExample: htmlmailer.py -s test -m \"<b>Hello</b>, my name is <i>Tom</i>\" -a FileToAttach mail.local sender@mail.com recipient@mail.local")
else:
