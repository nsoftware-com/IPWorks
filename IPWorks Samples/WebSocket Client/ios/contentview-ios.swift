...
struct ContentView: View, WSClientDelegate {
  ...
  var body: some View {
    ...
    {
      Text("This is a demo to show how to connect to a remote WebSocket server, send data, and receive the echoed response. Simply fill in the server and port to connect, then input data you would like to send.")
