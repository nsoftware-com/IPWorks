...
class httpurlDemo {
  private static HTTP http1 = new nsoftware.IPWorks.HTTP();

  private static void http1_OnSSLServerAuthentication(object sender, nsoftware.IPWorks.HTTPSSLServerAuthenticationEventArgs e) {
    if (e.Accept) return;
