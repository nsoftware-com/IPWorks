...
type
  TFormTelnet = class(TForm)
    ...
    procedure Telnet1DataIn(Sender: TObject; Text: String);
    ...
    procedure Telnet1SubOption(Sender: TObject; SubOption: String);
...
procedure TFormTelnet.Telnet1DataIn(Sender: TObject; Text: String);
begin
...
procedure TFormTelnet.Telnet1SubOption(Sender: TObject; SubOption: String);
begin
	Memo2.Lines.Add('SERVER: DO SUBOPTION ' + SubOption);
    Telnet1.DoSubOption := char(24) + char(0) + 'vt100';
end;
...
begin
    {send the character}
    Telnet1.DataToSend := Key;

    {add a line feed after carriage return}
    If Key = #13 Then Telnet1.DataToSend := #10;
