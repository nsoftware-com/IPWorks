...
try:
  ...
  while True:
    ...
    if command == "?" or command == "help":
      ...
      print("  type                               display the data type of the currently selected element")
      print("  quit                               exit the application")
      

    elif command == "children":
      print("Currently selected element contains " + str(json.get_x_child_count()) + " children.")
      for i in range(json.get_x_child_count()):
        elem_name = json.get_x_child_name(i)
        if len(elem_name) > 32:
          elem_name = elem_name[:29] + "..."
        elem_type = get_element_type_str(json.get_x_child_element_type(i))
      ...
      print("Removing current element \"{}\" ...".format(json.get_x_element()), end = '')
      json.remove()
      save_and_reparse(json)
      print("finished!")
    
    elif command == "rename":
      print("Renaming current element \"{}\" to \"{}\"...".format(json.get_x_element(), arguments[0]), end = '')
      json.set_name(arguments[0])
      save_and_reparse(json)
      print("finished!")

    elif command == "revalue":
      print("Changing value of current element \"{}\"...".format(json.get_x_element()), end = '')
      ...
      print(json.get_x_sub_tree())

    elif command == "text":
      text = json.get_x_text()
      if len(text) > 0:
        print(text)
      else:
